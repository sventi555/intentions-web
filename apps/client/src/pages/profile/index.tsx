...
const FollowListButton: React.FC<PropsWithChildren<FollowListButtonProps>> = ({
  onClick,
  children,
}) => {
  return (
    <button
      className="cursor-pointer rounded-2xl border border-neutral-300 bg-neutral-100 p-0.5 px-8 text-sm"
      onClick={onClick}
    >
      {children}
    </button>
